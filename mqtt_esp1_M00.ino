...
const char* ssid = "*******";  // Encoder le nom du réseau wifi
const char* password = "********";  // Encoder le mot de passe du réseau wifi
const char* mqtt_server = "******";  // Encoder l'adresse IP du broker mqtt
